...
<softReason> =
| If it's any consolation, rejecting such a qualified applicant as yourself was not easy by any means.
...
| If its any consolation, we considered your application until at least the second to last cut before dropping it.
;
...
<contrast> =
<contrastTransition> you were not one of our top applicants.
| <contrastTransition> you won't be among those attending this institution next year.
| <contrastTransition> you won't be matriculating to our institution next year.
;
